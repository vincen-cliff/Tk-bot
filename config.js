...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("+237676746654")
global.mongodb = process.env.MONGODB_URI || ""
global.port= process.env.PORT || 5000
global.email = 'tchindaazice@gmail.com'
global.github = 'https://github.com/naveeddogar/KING-MD'
global.location = 'pakistan/multan'
global.gurl = 'https://whatsapp.com/channel/0029VaUlOyxDJ6H5QLrfes1n' // add your username
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Tk-Bot' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Tk Joel' : process.env.OWNER_NAME,
